    ...
    const apartments: Apartment[] = [
      {
        ...
        description: 'Cozy one-bedroom apartment in the heart of Studentski grad, ideal for students or young professionals.'
      },
      {
        ...
        description: 'Affordable one-bedroom apartment in the popular Strelbishte area, great value for money.'
      },
      {
        ...
        description: 'Fun and vibrant one-bedroom apartment in Studentski grad, perfect for young students seeking a new adventure.'
      },
      {
        name: 'One bedroom on quiet street',
        location: 'Lozenets',
        id: 4,
        rooms: 2,
        price: 168000,
        ...
        description: 'Peaceful one-bedroom apartment located on a quiet street in Lozenets, an ideal place for relaxation.'
      },
      {
        ...
        description: 'Exceptional one-bedroom apartment in Malinova dolina, featuring AC, water heater, and a parking space.'
      },
    ];
